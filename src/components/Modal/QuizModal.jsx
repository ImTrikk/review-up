						...
						<div className="pt-5">
							<div className="flex gap-2 items-center">
								...
								<input
									...
									type="text"
									className="outline-none border border-primaryColor h-8 rounded px-2"
								/>
							</div>
							{/* Main Container */}
									...
									<div className=" pt-2">
										<div className="space-y-2 pt-2">
											{quiz.choices.map((choice, choiceIndex) => (
												<div
													key={choiceIndex}
													className="bg-white text-xs shadow p-3 rounded flex justify-between w-full items-center gap-10">
													<label
